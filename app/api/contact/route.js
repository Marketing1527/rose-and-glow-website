...
export async function POST(request) {
  try {
    ...
    await supabaseAdmin.from('appointments').insert({
      name, email, phone, service, date, time, message, status: 'pending'
    })

    // Save to subscribers
    await supabaseAdmin.from('subscribers').upsert(
      { name, email, subscribed: true },
      { onConflict: 'email' }
    )
      ...
      <div style="background-color:#fdf8f5;padding:40px 20px;font-family:Georgia,serif;">
        <div style="max-width:600px;margin:0 auto;background-color:#ffffff;border-radius:4px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.06);">
          <div style="background-color:#f5e8e3;padding:40px 40px 30px;text-align:center;">
            <img src="https://roseandglowhair.com/logo.png" alt="Rose & Glow" style="height:100px;width:auto;margin-bottom:10px;" />
          ...
          <div style="background-color:#f5e8e3;padding:30px 40px;text-align:center;">
            ...
            <p style="margin:0;">
              ...
              &nbsp;&nbsp;·&nbsp;&nbsp;
              <a href="mailto:hello@roseandglowhair.com" style="color:#a85b5b;font-size:12px;text-decoration:none;">hello@roseandglowhair.com</a>
            </p>
    ...
    await resend.emails.send({
      ...
      html: emailTemplate(`New Appointment Request`, `
        <p style="color:#3a2a2a;font-size:15px;line-height:1.8;margin-bottom:24px;">A new client has requested an appointment.</p>
        <div style="background:#fdf8f5;border-left:3px solid #c9a96e;padding:20px 24px;margin-bottom:24px;border-radius:2px;">
          ...
          <p style="margin:0 0 10px;color:#3a2a2a;font-size:14px;"><strong>Date:</strong> ${date || 'Not specified'} at ${time || 'Not specified'}</p>
    ...
    await resend.emails.send({
      ...
      html: emailTemplate(`Thank you, ${name}!`, `
        <p style="color:#3a2a2a;font-size:15px;line-height:1.8;margin-bottom:24px;">We've received your appointment request and will confirm within 24 hours!</p>
        <div style="background:#fdf8f5;border-left:3px solid #c9a96e;padding:20px 24px;margin-bottom:24px;border-radius:2px;">
        ...
        <p style="font-size:14px;margin:4px 0;"><a href="tel:17863574958" style="color:#a85b5b;text-decoration:none;">📞 (786) 357-4958</a></p>
        <p style="font-size:14px;margin:4px 0;"><a href="https://maps.google.com/?q=1076+SW+67th+Ave+Suite+201+Miami+FL+33144" style="color:#a85b5b;text-decoration:none;">📍 1076 SW 67th Ave, Suite 201, Miami, FL 33144</a></p>
      `)
    })
